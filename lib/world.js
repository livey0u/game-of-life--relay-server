...
const WHITE_COLOR_HSL = [360, 100, 100];
const DEAD = 0;
const ALIVE = 1;
...
class World extends EventEmitter {
	...
	evolve() {
		...
		this.emit(constants.EVOLUTION_EVENT, nextGenerationLayout);
	...
	evolveCell(cell) {
		...
		let nextGenCell = {x: cell.x, y: cell.y, state: DEAD, color: cell.color};
	...
	setCell(cell) {
		...
		if(!Array.isArray(cell.color) || cell.color.length !== 3 || !isColor(`hsl(${cell.color[0]}, ${cell.color[1]}%, ${cell.color[2]}%)`)) {
